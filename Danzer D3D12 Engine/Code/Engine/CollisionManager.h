...
private:
	...
	void CheckAABBCollision(Scene& scene, AABBCollider& col, GameEntity& colObj, entt::entity colEntity);
	void CheckRayCollision(Scene& scene, RayCollider& col, GameEntity& colObj, entt::entity colEntity);
	void CheckSphereCollision(Scene& scene, SphereCollider& col, GameEntity& colObj, entt::entity colEntity);
	...
	bool ObjectIsActive(GameEntity& obj);
};
