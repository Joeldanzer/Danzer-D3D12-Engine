...
{	
	...
	effectData.m_rs  = m_psoHandler->CreateRootSignature(2, textures.size(), PSOHandler::SAMPLER_DESC_WRAP, D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT, L"Model Effect RS: " + std::to_wstring(m_modelEffects.size() - 1));
